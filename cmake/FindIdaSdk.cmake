...
# including the SDK 9.x layout used by IDA 9.2/9.3.

include(CMakeParseArguments)
include(FindPackageHandleStandardArgs)

find_path(IdaSdk_DIR NAMES include/pro.h
                     HINTS "${IdaSdk_ROOT_DIR}" ENV IDASDK_ROOT ENV IDA_SDK_ROOT
                     PATHS "${CMAKE_CURRENT_LIST_DIR}/../third_party/idasdk"
                     PATH_SUFFIXES idasdk src
...
find_package_handle_standard_args(IdaSdk
  ...
  REQUIRED_VARS IdaSdk_DIR
                IdaSdk_INCLUDE_DIRS
  FAIL_MESSAGE "IDA SDK not found, try setting IdaSdk_ROOT_DIR to an extracted SDK directory"
)

set(IDA_SDK_VERSION 999)
...
set(_so64 "64${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(_plx "${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(_plx64 "64${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(_llx "${CMAKE_SHARED_LIBRARY_SUFFIX}")
set(_llx64 "64${CMAKE_SHARED_LIBRARY_SUFFIX}")
...
function(_ida_plugin name ea64 link_script)
  if(ea64)
    set(t ${name}${_so64})
  else()
    set(t ${name}${_so})
